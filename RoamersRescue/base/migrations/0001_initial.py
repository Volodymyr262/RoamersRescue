# Generated by Django 3.2.7 on 2023-09-11 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('stars', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='you can give a host 1-5 stars'), django.core.validators.MaxValueValidator(5, message='you can give a host 1-5 stars')])),
